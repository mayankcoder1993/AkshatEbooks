...
9. **Never display a temporary or reconstructed logo.** Use clean text-only branding while exact owner assets are unavailable. A book is not branding-complete until the actual approved crest and imprint logo render in their permitted locations across Web/Book View, DOCX and offline HTML.
