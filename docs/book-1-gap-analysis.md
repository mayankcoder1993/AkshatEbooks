...
| Experience variety | Repeated mission template | Chapters now use launch, laboratory, packing, maze, assembly, design, mapping and reliability experiences | Fixed | Editorial pass for repeated activity patterns |
