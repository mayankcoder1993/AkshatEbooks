...
export const lesson04 = {
  ...
  blocks: [
    ...
    { type: 'image', src: plusByType, file: 'src/assets/type-changes-plus.jpg', w: 1264, h: 843, alt: 'Two lanes compare integer addition with string joining using the plus symbol.', caption: 'The type changes what the plus sign does.', points: ['Numbers use `+` for addition: `3 + 4` becomes `7`.', 'Strings use `+` for joining: `"3" + "4"` becomes `"34"`.'] },
