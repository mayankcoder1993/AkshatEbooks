...
export const PREFACE = {
  ...
  blocks: [
    { type: 'image', src: image, file: 'src/assets/why-python-origin.jpg', w: 1536, h: 1024, alt: 'A difficult choice leads to a simpler Python bridge and then many kinds of useful work.', caption: 'Legend: 1 = quick scripts were limited, while larger C programs took more work. 2 = Python offered a clearer middle path. 3 = people now use that path for automation, websites, data, science and AI.' },
