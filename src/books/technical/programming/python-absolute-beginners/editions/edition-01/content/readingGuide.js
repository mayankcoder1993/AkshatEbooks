export const HOW_TO_READ = {
  ...
  blocks: [
    ...
    { type: 'steps', showHeading: false, items: [
      ...
      '**Prove what works.** Enter the chapter skill trial only after the worked examples. Meet its observable win condition, complete the compact checkpoint and record the rank you earned through evidence. At the end of the arc, combine the chapter tools into a larger working result.'
    ] },
