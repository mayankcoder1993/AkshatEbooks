...
export const lesson02 = {
  ...
  blocks: [
    { type: 'arc-progress', arcTitle: 'Create a Local Study Assistant', step: 2, total: 5, currentFocus: 'Understand the execution route', variant: 'mystery', label: 'OUR MYSTERY', title: 'Who translates our words into machine work?', text: 'We can read `print("Hello")`. The processor cannot read Python words. Yet the message still reaches the screen. We will uncover the helpers in the middle.', weKnowLabel: 'Clues we have', weNeedLabel: 'Questions to solve', weKnow: ['We write readable instructions in a source file.', 'Running the file produces a visible result.'], weNeed: ['What happens between the file and the processor?', 'Why can different languages take different routes?'] },
