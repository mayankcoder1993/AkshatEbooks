...
export const lesson13 = {
  ...
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Newman bridges the gap between exploratory testing in the Postman desktop app and automated deployment pipelines. In modern software organizations, automated tests must execute headlessly on every git push or pull request without human intervention.',
    },
    {
      type: 'image',
      layout: 'stacked',
